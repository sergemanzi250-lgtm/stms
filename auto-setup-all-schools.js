/**
 * Auto-setup script to create default time slots for ALL approved schools
 * Run this to set up time slots for every school in the system
 */
...
// Import the createSchoolTimeSlots function directly
const createSchoolTimeSlots = async (schoolId) => {
...
async function autoSetupAllSchools() {
    console.log('🚀 AUTO-SETTING UP TIME SLOTS FOR ALL SCHOOLS...\n')
    ...
    try {
        ...
        if (schools.length === 0) {
            console.log('⚠️  No approved schools found.')
            return
        }
        ...
        console.log('📊 AUTO-SETUP SUMMARY')
        console.log('=' .repeat(60))
        ...
        if (successfulSchools > 0) {
            ...
            console.log('School admins can now edit/modify their schedules as needed.')
        } else {
        ...
        console.error('💥 Fatal error during auto-setup:', error)
        process.exit(1)
    } finally {
        await db.$disconnect()
    }
